...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/summer-butterfly-40c3)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/summer-butterfly-40c3
```

A live public deployment of this template is available at [https://summer-butterfly-40c3.templates.workers.dev](https://summer-butterfly-40c3.templates.workers.dev)
